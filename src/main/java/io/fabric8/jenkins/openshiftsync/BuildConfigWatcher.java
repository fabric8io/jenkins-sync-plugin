                ...
                ACL.impersonate(ACL.SYSTEM,
                        new NotReallyRoleSensitiveCallable<Void, Exception>() {
                            ...
                            public Void call() throws Exception {
                                ...
                                Jenkins activeInstance = Jenkins
                                        .getActiveInstance();
                                ItemGroup parent = activeInstance;
                                if (job == null) {
                                    job = (WorkflowJob) activeInstance
                                            .getItemByFullName(jobFullName);
                                }
                                ...
                                WorkflowJob workflowJob = activeInstance
                                ...
                                if (workflowJob == null
                                    ...
                                    workflowJob = activeInstance
                                            .getItemByFullName(fullName,
                                                    WorkflowJob.class);

                                }
                                if (workflowJob == null) {
                                    logger.warning("Could not find created job "
                                            + fullName
                                            + " for BuildConfig: "
                                            + getNamespace(buildConfig)
                                            + "/"
